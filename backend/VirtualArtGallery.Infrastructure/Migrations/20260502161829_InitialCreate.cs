        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredRoomStyle = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtworksOfTheDay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArtworksOfTheDay_Artworks_ArtworkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtworkVotes_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtworksOfTheDay_ArtworkId",
                table: "ArtworksOfTheDay",
                column: "ArtworkId");

            migrationBuilder.CreateIndex(
                name: "IX_ArtworksOfTheDay_Date",
                table: "ArtworksOfTheDay",
                column: "Date",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ArtworkVotes_ArtworkId_UserId",
                table: "ArtworkVotes",
                columns: new[] { "ArtworkId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ArtworkVotes_UserId",
                table: "ArtworkVotes",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ArtworkId_UserId",
                table: "Reviews",
                columns: new[] { "ArtworkId", "UserId" },
                unique: true);
